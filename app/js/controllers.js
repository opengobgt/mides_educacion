...
angular.module('SAE.controllers', []).
  ...
  .controller('AttendanceCtrl', ['$scope', 'User', 'StudentsBySchool', function($scope, User, StudentsBySchool) {
     ...
     var students = [];
     angular.forEach(current_user.escuelas, function(escuela_id) {
       students.push(StudentsBySchool.query({escuela_id: escuela_id}));
     })
